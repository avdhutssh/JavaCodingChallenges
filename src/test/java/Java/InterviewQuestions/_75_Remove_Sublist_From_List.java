...
public class _75_Remove_Sublist_From_List {
	...
	private static final int CustomArrayList = 0;
	...
	public static void main(String[] args) {
		...
		List<Integer> list2 = new ArrayList<>(Arrays.asList(1, 2, 3, 4, 5, 6, 7, 8)); // fromIndex = 2, endIndex = 4
		List<Integer> list3 = new ArrayList<>(Arrays.asList(1, 2, 3, 4, 5, 6, 7, 8)); // fromIndex = 2, endIndex = 4
		// Output [1, 2, 5, 6, 7, 8]
