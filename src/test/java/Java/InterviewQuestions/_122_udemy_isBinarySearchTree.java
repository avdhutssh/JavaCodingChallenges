...
public class _122_udemy_isBinarySearchTree {
    ...
    public static boolean isBstHelper(TreeNode node, Integer lowerLim, Integer upperLim) {
        ...
        boolean isLeftBST = isBstHelper(node.left, lowerLim, node.value);
        boolean isRightBST = isBstHelper(node.right, node.value, upperLim);
